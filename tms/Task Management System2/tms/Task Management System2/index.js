...
function insertNewRecord(data)
{
    ...
    cell6.innerHTML=`<button id="sub-btn" style="background-color: hsl(213, 75%, 50%);color:white" onclick="subtaskbtn()" >Add Subtask</button><button onclick='onedit(this)' style="background-color: rgb(221, 221, 26);color:black" >Edit</button> <button onclick='ondelete(this)'>Delete</button>` 
}
...
//**********************************************code for subtask******************************************
var modal1=document.querySelector(".submodal");
var closebtn1=document.querySelector(".subclose-icon");
function subtaskbtn(){
