...
function insertNewRecord(data)
{
    ...
    cell6.innerHTML=`<button id="sub-btn" style="background-color: hsl(213, 75%, 50%);color:white" onclick="subtaskbtn()" >Add Subtask</button>
...
var subtaskids=[];
function subtaskbtn(){
    // document.getElementById("sub-btn").id= document.getElementById("taskid").value;
